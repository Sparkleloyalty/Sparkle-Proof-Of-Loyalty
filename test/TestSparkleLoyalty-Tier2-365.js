...
contract('SparkleLoyalty - Workflow @ Tier2(20%)', async accounts => {
  ...
  describe('Step2: Deposit Tokens', async () => {
    ...
    it('Increase reward tier to Tier2 (20%) (Eth: 0.20) passed', async () => {
      truffleAssert.eventEmitted(await pol.selectRewardTier(2, { from: USER1, value: tier2eth }), 'TierSelectedEvent');
    });
  });
