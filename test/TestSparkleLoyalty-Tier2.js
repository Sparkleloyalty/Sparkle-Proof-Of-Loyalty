 ...
 */
contract('SparkleLoyalty - Test coverage: Tier2(20%) Workflow', async accounts => {
  ...
  describe('Step2: Deposit 1,000 tokens to SparkleLoyalty by USER1', async () => {
     ...
     * @notice Sent: 0.10 eth Expected: 0.20 eth
     */
    it('selectRewardTier(2, { from: USER1, value: tier1eth }) should fail  failed', async () => {
      /// Attempt to select a new reward tier
      await pol.selectRewardTier(2, { from: USER1, value: tier1eth })
      .then((tx) => {
    ...
    /**
     * @dev Test purchase of tier2 reward boost(20%)
     * @notice Sent: 0.20 eth Expected: 0.20 eth
     */
    it('Increase reward tier to Tier2 (20%) (Sent: 0.20eth) passed', async () => {
     ...
     */
    it('selectRewardTier(1, { from: USER1, value: tier1eth }) should fail', async () => {
  ...
  describe('Step3: Claim loyalty Day 1', async () => {
     ...
     */
    it('Collected reward(s) should equal 0.16428 tokens', async () => {
      /// Return success if expected values are returned
      assert.equal(await pol.getTokensCollected(USER1) / 10e7, 0.16428);
    });
  });
  ...
  describe('Step3: Claim loyalty Day 2', async () => {
     ...
     */
    it('Collected reward(s) should equal 0.32858698 tokens', async () => {
      /// Return success if expected values are returned
      assert.equal(await pol.getTokensCollected(USER1) / 10e7, 0.32858698);
    });
  ...
  describe('Step3: Claim loyalty Day 3', async () => {
     ...
     */
    it('Collected reward(s) should equal 0.49292096 tokens', async () => {
      /// Return success if expected values are returned
      assert.equal(await pol.getTokensCollected(USER1) / 10e7, 0.49292096);
    });
  })
  ...
  describe('Step3: Claim loyalty Day 4', async () => {
     ...
     */
    it('Collected reward(s) should equal 0.65728193 tokens', async () => {
      /// Return success if expected values are returned
      assert.equal(await pol.getTokensCollected(USER1) / 10e7, 0.65728193);
    });
  ...
  describe('Step3: Claim loyalty Day 5', async () => {
     ...
     */
    it('Collected reward(s) should equal 0.8216699 tokens', async () => {
      /// Return success if expected values are returned
      assert.equal(await pol.getTokensCollected(USER1) / 10e7, 0.8216699);
    });
  ...
  describe('Step3: Claim loyalty Day 365 (Days 6-364 skipped)', async () => {
     ...
     */
    it('Collected reward(s) should equal 60.01106411 tokens', async () => {
      /// Return success if expected values are returned
      assert.equal(await pol.getTokensCollected(USER1) / 10e7, 60.01106411);
    });
  ...
  describe('Step4: Withdraw loyalty', async () => {
     ...
     */
    it('Currrent collected rewards should equal 60.01106411 tokens', async () => {
      /// Return success if expected values are returned
      assert.equal(await pol.getTokensCollected(USER1) / 10e7, 60.01106411);
    });
     ...
     */
    it('Total withdraw amount should equal 1060.01106411 tokens', async () => {
      /// Return success if expected values are returned
      assert.equal(await pol.getTotalBalance(USER1) / 10e7, 1060.01106411);
    });
     ...
     */
    it('getRewardTier(USER1) should equal Tier2', async () => {
  ...
  describe('Post: Audit claimed and token totals', async () => {
     ...
     */
    it('getTotalTokensClaimed() should return 60.01106411', async () => {
      ...
      .then((count) => {
        ...
        return assert.equal(count, 6001106411);
      })
      .catch((error) => {
        /// Should not get here, return failure
        return assert(false);
  ...
  describe('Finalize: Return any tokens deposited', async() => {
    ...
    it('Return tokens to Accounts[2]', async() => {
      ...
      await st.methods.transfer(accounts[1], 60.01106411 * 10e7).send({ from: accounts[2] });
    });
  });
